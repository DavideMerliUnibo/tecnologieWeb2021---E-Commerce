        ...
        <div class="col-12">
            <div class="row justify-content-center">
                <div class='col-10 col-md-8'>
                    <div id="carousel2" class="carousel slide carousel-fade" data-bs-ride="carousel2" data-pause="hover">
                        <div class="carousel-indicators">
                            <?php if(count($immagini)>=1):?>
                                <button type="button" data-bs-target="#carousel2" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                            <?php for($x = 0 ; $x<count($immagini)-1;$x++): ?>
                                <button type="button" data-bs-target="#carousel2" data-bs-slide-to="<?php echo $x + 1?>"  aria-label="Slide <?php echo $x + 2?>"></button>
                            <?php endfor; 
                                endif;?>
                        </div>
                        ...
                        <button class="carousel-control-prev m-auto" type="button" data-bs-target="#carousel2" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next m-auto" type="button" data-bs-target="#carousel2" data-bs-slide="next">
