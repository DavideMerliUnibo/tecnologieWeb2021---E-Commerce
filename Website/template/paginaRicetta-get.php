<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1 class="text-center my-3">Ricetta</h1>
            </div>
            <div class="col-12">
                <div class="row justify-content-center">
                    <div id="carousel1" class="carousel slide col-10 " data-bs-ride="carousel" data-pause="hover">
                        ...
                        <button class="carousel-control-prev m-auto" type="button" data-bs-target="#carousel1"
                            data-bs-slide="prev">
            ...
            <div class="col-12">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="row m-3 justify-content-around align-items-center d-md-none" id="calories">
                                    ...
                                    <div class="col-3 d-flex justify-content-end"><button type="button"
                                            data-bs-toggle="collapse" data-bs-target="#calInfo" aria-expanded="false"
                                            aria-controls="calInfo" class="btn btn-primary p-0 my-2">info+</button>
                                    </div>
                            ...
                            <div class="col-12">
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        latte
                                        <span class="badge bg-primary rounded-pill">2L</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        farina
                                        <span class="badge bg-primary rounded-pill">300g</span>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-12 col-md-9">
                        ...
                        <p class="text-justify">"totamuptas sit aspernatur aut odit aut fugit, sed quia consequuntur
                            magni
                ...
                <div class="row">
                    <div class="col-12">
                        <div tabindex="0" class="divScrollabile">
                            <article class="card-body card my-1">
                                <p>Ciao questo è un commento lol</p>
                                <p><span class="small">autore</span></p>
                            </article>
                            <article class="card-body card my-1">
                                <p>Ciao questo è un commento lol</p>
                                <p><span class="small">autore</span></p>
    ...
    <!--possibilità di inserire commento ci vorrebbe:-->
