...
--
-- Host: 127.0.0.1
-- Creato il: Gen 14, 2023 alle 22:45
...
(103, 'Prodotto inserito!', '2023-01-14', 'LuxMasayuki@gmail.com'),
(104, 'Immagine aggiunta!', '2023-01-14', 'LuxMasayuki@gmail.com');
...
CREATE TABLE `prodotto` (
  ...
  `legale` smallint(6) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `prodotto` (`codice`, `prezzoPerUnità`, `quantità`, `informazioni`, `mediaValutazione`, `nomeFungo`, `data`, `offerente`, `legale`) VALUES
(1, 14.91, 6, 'Raccolto in val di Fiemme. Ideale per molte ricette. Non velenoso. Ottimo per molte ricette a base di porcini.', 4.25, 'Boletus edulis', '2022-12-27', 'davide.merli5@studio.unibo.it', 1),
(2, 15, 1, 'Conosciuta fin dai tempi antichi come fungo in grado di provocare allucinazioni. E\' tra i funghi più conosciuti, specie a causa del suo aspetto appariscente.Non mangiare (a meno di non essere masochisti o sciamani).', 2, 'Amanita muscaria', '2022-11-01', 'ryan.perrina@studio.unibo.it', 1),
(3, 42.5, 7, 'Conosciuto anche come \"Spugnola falsa\" o \"Marugola\", è un fungo che porta alla sindrome giromitrica, e quindi disturbi gastrointestinali, cefalee e disidratazioni, e in alcuni casi anche alla morte. Ben riconoscibile per via di un gambo chiaro, corto e irregolare e un cappello camoscio scuro, con costolature sinuose che lo rendono simile a un acino di uva passa avvizzita, nasce in primavere nei boschi di conifere.', 0, 'Gyromitra Esculenta', '2023-01-14', 'ryan.perrina@studio.unibo.it', 1),
...
(5, 10, 60, 'Conosciuto anche come Manina Pallida, la Ramaria Pallida è simile alla Ramaria Formosa ma si distingue dalla sorella per via di un colore chiaro, tendente all’avorio con sfumature lilla all’apice dei rami. Larga 20 cm e alta 15 cm, è simile a un corallo o a un cavolfiore, e dal tronco partono rami venosi a forma di V. Cresce in estate e autunno in boschi di latifoglie e aghifoglie.', 0, 'Ramaria Pallida', '2023-01-14', 'ryan.perrina@studio.unibo.it', 1),
(6, 48.54, 25, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a nunc at mi venenatis vestibulum ut sit amet nisi. Cras consequat, tellus vitae pulvinar sagittis, nisi sem pulvinar felis, eu sollicitudin massa urna a magna. Mauris vehicula, mauris sit amet fringilla commodo, lacus lectus vestibulum lectus, sit amet eleifend urna lacus vel turpis. Curabitur sodales sagittis arcu quis mattis. Pellentesque placerat risus ac dignissim imperdiet. Aliquam nec vehicula metus, viverra auctor velit. Don', 2, 'Boletus edulis', '2022-12-21', 'LuxMasayuki@gmail.com', 1),
(8, 5, 8, 'Nota anche come spugnola, questo fungo primaverile si distingue per un cappello alveolato che ricorda appunto una spugna. Ne esistono più varietà per forma e colore e serve esperienza nella raccolta, perché possono confondersi con specie non commestibili. Le morchelle crude sono velenose, richiedono quindi molta attenzione al fine di eliminare in cottura le tossine contenute. In cucina sono utilizzate comunemente come contorno a piatti di carne e risotti. Sono vendute essiccate.', 0, 'Morchella ', '2023-01-13', 'ev.giangusto@yahoo.it', 1),
(15, 35, 19, 'Mycena chlorophos è una specie di fungo agarico della famiglia delle Mycenaceae. I corpi fruttiferi di Mycena chlorophos si trovano nelle foreste, dove crescono in gruppi su detriti legnosi come ramoscelli caduti, rami e corteccia.  La fruttificazione avviene solo nelle stagioni piovose di giugno/luglio e settembre/ottobre, quando l\'umidità relativa è di circa l\'88%. La luminescenza massima si verifica a 27 °C.', 0, 'Mycena chlorophos', '2023-01-10', 'davide.merli5@studio.unibo.it', 1),
(18, 19.99, 30, 'L\'Agaricus bisporus, è un fungo basidiomicete della famiglia delle Agaricaceae, molto apprezzato in cucina. È largamente coltivato e poi commercializzato in tutto il mondo; in questo caso è noto anche con il nome in francese di champignon.', 0, 'Agaricus bisporus', '2023-01-14', 'LuxMasayuki@gmail.com', 1),
(19, 32, 48, 'Il suo nome comune \"Shiitake\" deriva dalla parola Giapponese \"shii\" usata per indicare una varietà di albero di castagno e dalla parola \"take\" che significa fungo.È attualmente il secondo fungo commestibile più consumato al mondo, dopo lo champignon.', 0, 'Lentinula edodes', '2023-01-14', 'testuser@gmail.com', 1),
(21, 30, 3, 'La Mycena pura è un fungo di piccola taglia, di colore rosa o violetto. Ha un caratteristico odore di ravanello e compare nei boschi in autunno sino all’inverno inoltrato. La dimensione del cappello oscilla tra i 2 cm ai 6 cm di diametro e cresce per gran parte dell’anno in ogni tipo di bosco.', 0, 'Mycena pura', '2022-12-21', 'furbissimo@studio.unibo.it', 0),
(22, 40, 3, 'La Psilocybe semilanceata cresce principalmente nella stagione autunnale in terreni umidi tra i 1000 e i 2000 metri di altitudine. Ha un gambo lungo e sottile, color bruno-olivastro. Un elemento prezioso per riconoscerlo è il fatto che, pochi minuti dopo esser stato colto, assume una tonalità nettamente bluastra o verdastra nella parte inferiore del gambo.', 0, ' Psilocybe semilanceata', '2022-12-21', 'furbissimo@studio.unibo.it', 0),
(23, 50, 2, 'Numerosi esemplari di questo fungo tossico sono stati recentemente trovati  sull’Aspromonte, in Calabria, ed al Passo Lanciano, in Abruzzo. Ritrovamenti che confermerebbero la sua presenza stabile nei boschi italiani.  Come riconoscerlo? L’altezza del cappello è di circa 1,5-5 cm, ha un gambo color panna e un cappello marroncino. Le parti toccate tendenzialmente si colorano di blu.', 0, ' Psilocybe cyanescens', '2022-12-21', 'furbissimo@studio.unibo.it', 0),
(24, 60, 2, 'E’ un fungo molto appariscente, color giallo vivo, che  può raggiungere dimensioni notevoli con cappello di 5-20 cm di diametro, con un gambo cilindrico e ingrossato al centro. Vive sulle ceppaie, sulle basi dei tronchi e radici di alberi, sia vivi che morti.', 0, 'Gymnopilus spectabilis', '2022-12-21', 'furbissimo@studio.unibo.it', 0);
...
CREATE TABLE `tipologiafungo` (
  ...
  `legale` tinyint(4) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tipologiafungo` (`nomeScientifico`, `indiceRarità`, `indiceQualità`, `indiceVelenosità`, `legale`) VALUES
(' Psilocybe cyanescens', 8, 8, 3, 0),
(' Psilocybe semilanceata', 8, 4, 1, 0),
('Agaricus bisporus', 2, 8, 0, 1),
('Amanita muscaria', 2, 5, 9, 1),
('Boletus edulis', 1, 7, 0, 1),
('Cantharellus cibarius', 4, 6, 2, 1),
('Gymnopilus spectabilis', 8, 8, 5, 0),
('Gyromitra Esculenta', 4, 2, 9, 1),
('Lentinula edodes', 1, 10, 0, 1),
('Morchella ', 2, 8, 0, 1),
('Mycena chlorophos', 2, 10, 0, 1),
('Mycena pura', 7, 7, 2, 0),
('Ramaria Pallida', 5, 5, 6, 1);
...
--
ALTER TABLE `notifica`
  MODIFY `codice` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;
